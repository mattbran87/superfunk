...
Every task-quality review now re-reads the cited doc section before finalizing a convention-based finding — a small, bounded verification step already implicit in the reviewer's general "Do Not Trust the Report" discipline, made explicit for this one recurring failure mode.
